...
const trendyolmillaHunter: ProductHunter = async (params: ShopSearchOptions) => {
  try {
    let {
      page = 1,
      query = '',
    ...
    const productsPromise = (async () => {
      let productsUrl =
        'https://public.trendyol-milla.com/discovery-web-searchgw-service/v2/api/filter/sr?channelId=8&' +
        productSearchParams;
...
export default trendyolmillaHunter;
